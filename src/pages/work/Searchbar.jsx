...
export default function Searchbar() {
  ...
  return (
    <>
      ...
      <Row>
        <Col span={24} className={`${styles.layout} ${styles.searchLayout}`}>
          {/* 항상 보이는 영역 */}
          <Space direction="vertical" size="middle" style={{ display: "flex" }}>
            <Row gutter={20}>
              <Col6>
                <LabeledField label="신청일자">
                  <RangePicker variant="underlined" placeholder="" />
                </LabeledField>
              </Col6>
              <Col6>
                <LabeledField label="시승일자">
                  <RangePicker variant="underlined" placeholder="" />
                </LabeledField>
              </Col6>
              <Col6>
                <LabeledField label="반환일자">
                  <RangePicker variant="underlined" placeholder="" />
                </LabeledField>
              </Col6>
              <Col6>
                ...
                <Row gutter={20}>
                  ...
                  <Col6>
                    <LabeledField label="고객명">
                      <Input
                        variant="underlined"
                        placeholder="한글 또는 영어만 입력하시기 바랍니다"
                      />
                    </LabeledField>
                  </Col6>
                  <Col6>
